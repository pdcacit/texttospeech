...
public class TextToSpeechDemo {
	/*	
	 * Please refer on Text_To_Speech_HandsOn.ppt
	 * Visit API Reference https://www.ibm.com/watson/developercloud/text-to-speech/api/v1/
	 ...
	 * On API Reference: Click on Synthesis > Synthesize audio
